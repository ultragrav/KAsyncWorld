...
class ChangeIterationStrategyTest {
    ...
    fun testGet() {
        ...
        assertTrue(strategy.contains(0))
        assertTrue(strategy.contains(3))
        assertFalse(strategy.contains(1))
        assertFalse(strategy.contains(2))
        assertFalse(strategy.contains(4))
        assertFalse(strategy.contains(5))
        assertFalse(strategy.contains(6))
        assertFalse(strategy.contains(7))
        assertFalse(strategy.contains(8))
        assertFalse(strategy.contains(9))
    }
}